...
public class Modeltrext<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("metamobs", "modeltrext"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(36, 38).addBox(-7.0F, 0.0F, -9.0F, 14.0F, 6.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(0, 67)
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -6.2669F, -1.7683F, 12.0F, 11.0F, 14.0F, new CubeDeformation(0.0F))
						.texOffs(31, 76).addBox(-3.0F, -1.2669F, 28.2317F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(49, 117)
		...
		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(34, 90).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(114, 33)
		...
		PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(76, 42).addBox(-1.5F, -1.0F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(110, 60)
		...
		PartDefinition cube_r3 = body.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(110, 68).addBox(-1.5F, -1.5F, -3.0F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(70, 111)
		...
		PartDefinition cube_r4 = body.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(99, 36).addBox(-2.0F, -3.0F, -3.0F, 4.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(85, 100)
		...
		PartDefinition cube_r5 = body.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(66, 56).addBox(-1.0F, -13.2F, 51.5F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 29.2331F, -1.7683F, 0.3491F, 0.0F, 0.0F));
		PartDefinition cube_r6 = body.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(94, 77).addBox(-2.0F, -23.0F, 42.0F, 4.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 29.7331F, -1.7683F, 0.1745F, 0.0F, 0.0F));
		PartDefinition cube_r7 = body.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(68, 68).addBox(-4.0F, -36.0F, 19.0F, 8.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(35, 56)
		...
		PartDefinition cube_r8 = body.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(0, 26).addBox(-6.0F, -5.5F, -5.5F, 12.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.8269F, -5.9475F, -0.2182F, 0.0F, 0.0F));
		PartDefinition cube_r9 = body.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(42, 15).addBox(-4.0F, -3.5F, -4.5F, 10.0F, 9.0F, 11.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, -5.7491F, -16.7253F, -0.3054F, 0.0F, 0.0F));
		PartDefinition rightleg = partdefinition.addOrReplaceChild("rightleg",
				CubeListBuilder.create().texOffs(0, 98).addBox(-4.9451F, 27.8668F, -6.8253F, 5.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
						.texOffs(0, 109).addBox(-3.9451F, 28.8668F, -12.8253F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(66, 56)
		...
		PartDefinition cube_r10 = rightleg.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(0, 53).addBox(-6.5F, 2.0F, 0.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(85, 15)
		...
		PartDefinition cube_r11 = rightleg.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(0, 66).addBox(-13.5F, 2.0F, -6.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(90, 88)
		...
		PartDefinition cube_r12 = rightleg.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(113, 84).addBox(-11.0F, -11.0F, 5.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(18, 104)
		...
		PartDefinition cube_r13 = rightleg.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(41, 94).addBox(-11.0F, -25.0F, 1.0F, 3.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(76, 27)
		...
		PartDefinition cube_r14 = rightleg.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(0, 83).addBox(-13.0F, -29.0F, -21.0F, 6.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.0549F, 29.8941F, -8.0986F, -0.8727F, 0.0F, 0.0F));
		PartDefinition leftleg = partdefinition.addOrReplaceChild("leftleg",
				CubeListBuilder.create().texOffs(103, 0).addBox(2.0549F, 28.8668F, -12.8253F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
						.texOffs(39, 0).addBox(2.5549F, 29.8668F, -13.8253F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(93, 63)
		...
		PartDefinition cube_r15 = leftleg.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(52, 82).addBox(-7.0F, 1.0F, 1.0F, 3.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 49)
		...
		PartDefinition cube_r16 = leftleg.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(39, 4).addBox(-13.5F, 2.0F, -6.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(75, 84)
						.addBox(-14.0F, 1.0F, -5.0F, 3.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(13.0549F, 27.8668F, -10.8253F, 0.0F, 0.3491F, 0.0F));
		PartDefinition cube_r17 = leftleg.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(57, 107).addBox(-12.0F, -15.0F, 4.0F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(102, 111)
		...
		PartDefinition cube_r18 = leftleg.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(80, 49).addBox(-12.0F, -29.0F, -21.0F, 6.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = leftleg.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(74, 0).addBox(-12.0F, -30.0F, 0.0F, 5.0F, 5.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(20, 90)
