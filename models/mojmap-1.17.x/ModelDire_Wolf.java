...
public class ModelDire_Wolf<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "dire_wolf"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(22, 15)
						.addBox(-2.9998F, -2.3953F, -4.993F, 6.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(28, 7)
						.addBox(-1.9998F, 0.5847F, -7.993F, 4.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(39, 4)
						.addBox(-1.4998F, 0.4847F, -7.943F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(22, 47)
						.addBox(-0.9998F, 0.3847F, -7.693F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(38, 12)
						.addBox(-2.4998F, -1.8453F, -0.993F, 5.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.0002F, 12.8953F, -4.007F));

		PartDefinition head_r1 = head.addOrReplaceChild("head_r1",
				CubeListBuilder.create().texOffs(0, 4)
						.addBox(1.4F, -1.5F, -1.3F, 0.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						...
						.addBox(-1.0F, -0.4F, -1.3F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(13, 45)
		...
		PartDefinition head_r2 = head.addOrReplaceChild("head_r2",
				CubeListBuilder.create().texOffs(54, 4).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F,
		...
		PartDefinition head_r7 = head.addOrReplaceChild("head_r7",
				CubeListBuilder.create().texOffs(44, 51).addBox(-1.0F, -1.5F, -0.5F, 2.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.3955F, -2.6194F, -3.093F, 0.0F, 0.0F, 0.2618F));

		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create(),
				PartPose.offset(0.0F, 13.4337F, -0.0709F));

		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 15)
						.addBox(-2.5F, -2.35F, 4.0F, 5.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-3.0F, -2.85F, -4.0F, 6.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 27).addBox(-2.0F, -2.5F, -0.5F, 4.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.1163F, -4.4291F, -0.3927F, 0.0F, 0.0F));

		PartDefinition tail = body.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(46, 46)
						.addBox(-1.5F, 0.4834F, 13.6662F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(51, 17)
		...
		PartDefinition cube_r3 = tail.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(45, 37)
						.addBox(-1.0F, 0.4F, 11.25F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(36, 46)
		...
		PartDefinition cube_r4 = tail.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(28, 28)
						.addBox(-1.0F, 0.4F, 10.25F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(8, 30)
		...
		PartDefinition cube_r5 = tail.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(16, 32)
						.addBox(-1.0F, -1.0F, 10.25F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 34)
						.addBox(-1.0F, 0.4F, 10.25F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(20, 0)
						.addBox(-1.5F, -0.85F, 10.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 4.1887F, 9.4731F, 0.3491F, 0.0F, 0.0F));

		PartDefinition cube_r6 = tail.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 15)
						.addBox(0.5F, 0.15F, 10.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(50, 13)
		...
		PartDefinition cube_r7 = tail.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(38, 34)
						.addBox(0.5F, 0.15F, 10.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(6, 42)
		...
		PartDefinition rightleg1 = partdefinition.addOrReplaceChild("rightleg1",
				CubeListBuilder.create().texOffs(34, 4)
						.addBox(-2.5F, 8.8984F, 2.029F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(9, 38)
		...
		PartDefinition cube_r11 = rightleg1.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(43, 46)
						.addBox(-3.25F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(45, 42)
						.addBox(-4.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(33, 47)
						.addBox(-5.75F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = rightleg1.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(16, 42)
						.addBox(-3.25F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(6, 41)
						.addBox(-5.75F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 42)
						.addBox(-4.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = rightleg1.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(30, 50).addBox(-5.0F, -0.85F, -4.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = rightleg1.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(31, 38).addBox(-5.0F, -0.85F, -4.0F, 2.0F, 7.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition rightleg2 = partdefinition.addOrReplaceChild("rightleg2",
				CubeListBuilder.create().texOffs(48, 4)
						.addBox(-0.25F, 5.8715F, -2.1851F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(29, 47)
		...
		PartDefinition cube_r15 = rightleg2.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(0, 46).addBox(-5.0F, 1.15F, -4.0F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = rightleg2.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(8, 49).addBox(-5.0F, -0.85F, -4.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r17 = rightleg2.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(35, 26)
						.addBox(-5.75F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 36)
						.addBox(-4.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(39, 40)
						.addBox(-3.25F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = rightleg2.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(20, 38)
						.addBox(-4.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(29, 38)
						.addBox(-5.75F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 40)
						.addBox(-3.25F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, 6.9606F, -3.0782F, 0.829F, 0.0F, 0.0F));

		PartDefinition leftleg1 = partdefinition.addOrReplaceChild("leftleg1", CubeListBuilder.create().texOffs(44, 0)
				.addBox(-0.6111F, 8.7591F, -0.7268F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(36, 25)
				.addBox(-1.1111F, 8.9091F, -0.8268F, 4.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(53, 31)
				...
				.addBox(0.3889F, 9.0091F, -2.0768F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(28, 25)
				.addBox(-0.6111F, 8.9091F, 2.1732F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.1111F, 14.0535F, -3.4503F));

		PartDefinition cube_r19 = leftleg1.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(19, 43)
						.addBox(4.75F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(39, 42)
						.addBox(3.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(42, 22)
						.addBox(2.25F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = leftleg1.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(53, 34)
						.addBox(4.75F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(4, 53)
						.addBox(3.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(14, 49)
						.addBox(2.25F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r21 = leftleg1.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(16, 50).addBox(3.0F, -0.85F, -4.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r22 = leftleg1.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(23, 38).addBox(3.0F, -0.85F, -4.0F, 2.0F, 7.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition leftleg2 = partdefinition.addOrReplaceChild("leftleg2",
				CubeListBuilder.create().texOffs(40, 29)
						.addBox(-0.5F, 5.6215F, -0.8351F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(30, 0)
		...
		PartDefinition cube_r23 = leftleg2.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(0, 34)
						.addBox(4.75F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(16, 32)
						.addBox(3.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 27)
						.addBox(2.25F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 6.9606F, -3.0782F, 0.829F, 0.0F, 0.0F));

		PartDefinition cube_r24 = leftleg2.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(18, 27)
						.addBox(4.75F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 2)
						.addBox(3.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 0)
						.addBox(2.25F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 6.5248F, -2.4557F, 0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r25 = leftleg2.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(49, 7).addBox(3.0F, -0.85F, -4.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 4.8673F, 4.4084F, -0.48F, 0.0F, 0.0F));

		PartDefinition cube_r26 = leftleg2.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(0, 0).addBox(3.0F, 1.15F, -4.0F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -3.2574F, 2.5211F, 0.3927F, 0.0F, 0.0F));
