...
public class ModelRock_Dudet<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "rock_dude"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leftleg1 = partdefinition.addOrReplaceChild("leftleg1",
				CubeListBuilder.create().texOffs(40, 0)
						.addBox(0.0F, 3.3239F, -6.4837F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 40)
						.addBox(0.0F, -1.3239F, -1.5163F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(4.0F, 18.6761F, -1.5163F));

		PartDefinition cube_r1 = leftleg1.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 27).addBox(-0.5F, -1.5F, -1.0F, 2.0F, 2.0F, 7.0F,
		...
		PartDefinition leftleg2 = partdefinition.addOrReplaceChild("leftleg2",
				CubeListBuilder.create().texOffs(14, 16)
						.addBox(0.0F, -1.3239F, -0.4837F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 16)
						.addBox(0.0F, 3.3239F, 4.4837F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(4.0F, 18.6761F, 1.5163F));

		PartDefinition cube_r2 = leftleg2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(13, 20).addBox(-0.5F, -1.5F, -1.0F, 2.0F, 2.0F, 7.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition rightleg1 = partdefinition.addOrReplaceChild("rightleg1",
				CubeListBuilder.create().texOffs(8, 36)
						.addBox(-2.0F, 3.3239F, -6.4837F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 36)
						.addBox(-2.0F, -1.3239F, -1.5163F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-4.0F, 18.6761F, -1.5163F));

		PartDefinition cube_r3 = rightleg1.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(24, 25).addBox(-0.5F, -1.5F, -1.0F, 2.0F, 2.0F, 7.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition rightleg2 = partdefinition.addOrReplaceChild("rightleg2",
				CubeListBuilder.create().texOffs(35, 17)
						.addBox(-2.0F, -1.3239F, -0.4837F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(35, 25)
						.addBox(-2.0F, 3.3239F, 4.4837F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-4.0F, 18.6761F, 1.5163F));

		PartDefinition cube_r4 = rightleg2.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(24, 16).addBox(-0.5F, -1.5F, -1.0F, 2.0F, 2.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, 0.4063F, 1.01F, -0.8727F, 0.0F, 0.0F));

		PartDefinition bodyhead = partdefinition.addOrReplaceChild("bodyhead", CubeListBuilder.create().texOffs(0, 16)
				.addBox(-5.8448F, -3.8361F, -9.7799F, 4.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.8448F, 17.1882F, 3.7473F));

		PartDefinition cube_r5 = bodyhead.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(11, 29).addBox(-3.0F, -2.0F, -2.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = bodyhead.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(35, 12).addBox(-5.0F, -2.0F, -2.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = bodyhead.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -2.0F, -2.0F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = bodyhead.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(24, 0).addBox(-3.0F, -2.0F, -2.0F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = bodyhead.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(26, 34).addBox(-5.0F, -2.0F, -2.0F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = bodyhead.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(34, 34).addBox(-3.0F, -2.0F, -2.0F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = bodyhead.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(32, 0).addBox(-7.0F, -2.0F, -1.0F, 2.0F, 10.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = bodyhead.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(18, 32).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 10.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = bodyhead.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -6.0F, -5.0F, 8.0F, 8.0F, 8.0F,
						new CubeDeformation(0.0F)),
